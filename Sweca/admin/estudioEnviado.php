...
<?php
			...
			if(isset($end_insert)){
				...
				$insert = "insert into Estudios(nombre) values('$nombre')";
				mysqli_query($conn, $insert) or die("Error al insertar Estudio.");
				echo "<h2>Estudio '$nombre' insertado correctamente.</h2>";
				mysqli_close($conn);
            }
		?>
        </div>
