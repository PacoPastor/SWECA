...
<body>
    ...
    <div class="well col-md-offset-1">
			<div class="texto">
				<h2>Insertar nueva dimension</h2>
				<form action="dimensionEnviada.php" method="post" enctype="multipart/form-data">
                <?php
                ...
                echo "<label class='radio col-md-offset-1'><input type='radio' name='id_estudio' value='".$res['id']."' checked>".$res['nombre']."</label>";
                while($res = mysqli_fetch_array($query)){
                    echo "<label class='radio col-md-offset-1'><input type='radio' name='id_estudio' value=".$res['id'].">".$res['nombre']."</label>";
                }
                ?>
				<p><label class="form-group">Nombre de la dimension: <input class="user_entrada" type="text" name="nombre" placeholder="Nombre de estudio" ></label></p>
				<p><label>Comentario asociado: <br><textarea class="form-control" name ='comentario' cols='60' rows='5' placeholder='Escribe aquí al menos una frase, para introducir de forma de comentario explicativo...'></textarea></label></p>
				<p ><label><input class='btn btn-primary' type="submit" name="end_insert"></label></p>
			</form>
		</div>
    </div>
    <footer>
